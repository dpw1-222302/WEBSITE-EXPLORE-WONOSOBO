...
<body>
    ...
    <!-- Header -->
    <div>
        <img src="img/airterjun/header.jpg" class="w-100">
    </div>
    <!-- End Header -->
    ...
    <div class="container my-5">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4">
            ...
            ?>
                ...
                <!-- Detail air terjun -->
                <div class="modal fade" id="exampleModal<?= $data['air_terjun_id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content rounded-4">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel"><?= $data['nama_air_terjun'] ?></h1>
                ...
                <!-- End Detail air terjun -->
            <?php endforeach ?>
        </div>
    </div>
    <!-- End air terjun di Wonosobo -->
