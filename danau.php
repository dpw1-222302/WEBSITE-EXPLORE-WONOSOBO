...
<body>
    ...
    <!-- Header -->
    <div>
        <img src="img/danau/header.jpg" class="w-100">
    </div>
    <!-- End Header -->

    <!-- Danau-danau di Wonosobo -->
    <div class="container my-5">
        <div class="text-center mb-5">
            <h1>Danau di Wonosobo</h1>
        </div>
        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4">
            ...
            ?>
                ...
                <!-- Detail Danau -->
                <div class="modal fade" id="exampleModal<?= $data['danau_id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content rounded-4">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel"><?= $data['nama_danau'] ?></h1>
